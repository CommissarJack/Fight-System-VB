Public Class Arena
    ...
    'The foundations of the movement system was done by Tony Dougal & Chandler 
    Dim nplayerx As Integer = 0
    Dim nplayery As Integer = 0
    Dim pplayerx As Integer = 0
    Dim pplayery As Integer = 0
    Public Shared playerHP As Integer = 100
    Public Shared energy As Integer = 5
    Dim differencex As Integer
    Dim differencey As Integer
    Dim MoveDif As Integer
    Dim energyCheck As Integer
    Public Shared playerTurn As Boolean = True
    ...
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        cordX.Text = "X cord: " & nplayerx
        cordY.Text = "Y cord: " & nplayery
        energylbl.Text = "Energy: " & energy

        If nplayerx = 0 And nplayery = 0 Then
            clearCoordinates()
            x0y0.Image = player.Image
        End If

        If nplayerx = 0 And nplayery = 1 Then
            clearCoordinates()
            x0y1.Image = player.Image
        End If

        If nplayerx = 0 And nplayery = 2 Then
            clearCoordinates()
            x0y2.Image = player.Image
        End If

        If nplayerx = 1 And nplayery = 0 Then
            clearCoordinates()
            x1y0.Image = player.Image
        End If

        If nplayerx = 1 And nplayery = 1 Then
            clearCoordinates()
            x1y1.Image = player.Image
        End If

        If nplayerx = 1 And nplayery = 2 Then
            clearCoordinates()
            x1y2.Image = player.Image
        End If

        If nplayerx = 2 And nplayery = 0 Then
            clearCoordinates()
            x2y0.Image = player.Image
        End If

        If nplayerx = 2 And nplayery = 1 Then
            clearCoordinates()
            x2y1.Image = player.Image
        End If

        If nplayerx = 2 And nplayery = 2 Then
            clearCoordinates()
            x2y2.Image = player.Image
        End If

        If nplayerx = 3 And nplayery = 0 Then
            clearCoordinates()
            x3y0.Image = player.Image
        End If

        If nplayerx = 4 And nplayery = 0 Then
            clearCoordinates()
            x4y0.Image = player.Image
        End If

        If nplayerx = 5 And nplayery = 0 Then
            clearCoordinates()
            x5y0.Image = player.Image
        End If

        If nplayerx = 6 And nplayery = 0 Then
            clearCoordinates()
        ...
        If nplayerx = -3 And nplayery = 1 Then
            clearCoordinates()
            xn3y1.Image = player.Image
        End If

        If nplayerx = -4 And nplayery = 1 Then
            clearCoordinates()
            xn4y1.Image = player.Image
        End If

        If nplayerx = -5 And nplayery = 1 Then
            clearCoordinates()
            xn5y1.Image = player.Image
        End If

        If nplayerx = -6 And nplayery = 1 Then
            clearCoordinates()
        ...
        If nplayerx = -3 And nplayery = -2 Then
            clearCoordinates()
            xn3yn2.Image = player.Image
        End If

        If nplayerx = -4 And nplayery = -2 Then
            clearCoordinates()
            xn4yn2.Image = player.Image
        End If

        If nplayerx = -5 And nplayery = -2 Then
            clearCoordinates()
        ...
        If nplayerx = -1 And nplayery = -3 Then
            clearCoordinates()
            xn1yn3.Image = player.Image
        End If

        If nplayerx = -2 And nplayery = -3 Then
            clearCoordinates()
            xn2yn3.Image = player.Image
        End If

        If nplayerx = -3 And nplayery = -3 Then
            clearCoordinates()
            xn3yn3.Image = player.Image
        End If

        If nplayerx = -4 And nplayery = -3 Then
            clearCoordinates()
            xn4yn3.Image = player.Image
        End If

        If nplayerx = -5 And nplayery = -3 Then
            clearCoordinates()
        ...
        If nplayerx = 0 And nplayery = -3 Then
            clearCoordinates()
            x0yn3.Image = player.Image
        End If

        If nplayerx = -1 And nplayery = -4 Then
            clearCoordinates()
            xn1yn4.Image = player.Image
        End If

        If nplayerx = -2 And nplayery = -4 Then
            clearCoordinates()
            xn2yn4.Image = player.Image
        End If

        If nplayerx = -3 And nplayery = -4 Then
            clearCoordinates()
            xn3yn4.Image = player.Image
        End If

        If nplayerx = -4 And nplayery = -4 Then
            clearCoordinates()
        ...
        If nplayerx = 0 And nplayery = -4 Then
            clearCoordinates()
            x0yn4.Image = player.Image
        End If

        If nplayerx = 0 And nplayery = -5 Then
            clearCoordinates()
            x0yn5.Image = player.Image
        End If

        If nplayerx = -1 And nplayery = -5 Then
            clearCoordinates()
            xn1yn5.Image = player.Image
        End If

        If nplayerx = -2 And nplayery = -5 Then
            clearCoordinates()
            xn2yn5.Image = player.Image
        End If

        If nplayerx = -3 And nplayery = -5 Then
            clearCoordinates()
        ...
        If nplayerx = 1 And nplayery = -6 Then
            clearCoordinates()
            x1yn6.Image = player.Image
        End If
        If nplayerx = 0 And nplayery = -6 Then
            clearCoordinates()
    ...
    Public Function showPlayerCoordinate() As Boolean
        ...
        If pplayerx > nplayerx Then
            differencex = pplayerx - nplayerx
        Else
            differencex = nplayerx - pplayerx
        End If

        If pplayery > nplayery Then
            differencey = pplayery - nplayery
        Else
            differencey = nplayery - pplayery
        End If

        MoveDif = differencex + differencey
        energyCheck = MoveDif - energy

        If MoveDif <= energy Then
            pplayerx = nplayerx
            pplayery = nplayery
            energy -= MoveDif
        Else
    ...
    Private Sub endTurnbtn_Click(sender As Object, e As EventArgs)
        playerTurn = False
        energy = 5
